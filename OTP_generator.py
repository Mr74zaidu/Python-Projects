...
Button(frame, width=39, pady=7, text='Validate OTP', bg='#57a1f8', fg='white', border=0, command=validate_otp).place(x=35, y=340)

# Sign Up Button
Button(frame, width=39, pady=7, text='Sign Up', bg='#57a1f8', fg='white', border=0).place(x=35, y=380)
